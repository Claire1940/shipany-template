...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      description:
        'custom your <a href="https://affonso.io?ref=oneaihub" class="text-primary" target="_blank">Affonso</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'promotekit',
      ...
      description:
        'custom your <a href="https://www.promotekit.com?via=oneaihub" class="text-primary" target="_blank">PromoteKit</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'crisp',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'OneAIHub is an all-in-one AI platform for chat, image generation, music creation, and credits.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'OneAIHub <no-reply@oneaihub.online>',
      group: 'resend',
      tab: 'email',
    },
    {
