    ...
    >
        ...
        {texts && texts.length > 0 ? (
          <h1 className="text-foreground text-4xl font-semibold text-balance sm:mt-12 sm:text-6xl">
            ...
            <span className="text-primary">
              <Highlighter action="underline" color="oklch(0.76 0.18 220)">
                {highlightText}
              </Highlighter>
            </span>
            {texts[1]}
      ...
      {section.background_image?.src && (
        <div className="absolute inset-0 -z-10 hidden h-full w-full overflow-hidden md:block">
          <div className="from-background via-background/85 to-background/95 absolute inset-0 z-10 bg-gradient-to-b" />
          <div className="absolute inset-0 z-10 bg-[radial-gradient(circle_at_50%_20%,var(--color-primary)/25%,transparent_38%),radial-gradient(circle_at_80%_10%,var(--color-accent)/20%,transparent_32%)]" />
          <Image
